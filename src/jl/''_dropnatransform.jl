...
export ''_dropnatransform

"""
    ''_dropnatransform(;kwargs...)
...
"""
function ''_dropnatransform(; kwargs...)
        available_props = Symbol[:allColOptions, :catColOptions, :config, :meta, :numColOptions]
        wild_props = Symbol[]
        return Component("''_dropnatransform", "DropnaTransform", "dash_express_components", available_props, wild_props; kwargs...)
end
