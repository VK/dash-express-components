...
export ''_scattermatrix

"""
    ''_scattermatrix(;kwargs...)
...
"""
function ''_scattermatrix(; kwargs...)
        available_props = Symbol[:allColOptions, :catColOptions, :config, :numColOptions]
        wild_props = Symbol[]
        return Component("''_scattermatrix", "ScatterMatrix", "dash_express_components", available_props, wild_props; kwargs...)
end
