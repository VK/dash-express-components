...
`name` and `id` are the only required parameters.. columns has the following type: Array of lists containing elements 'id', 'name', 'type', 'presentation', 'selectable', 'clearable', 'deletable', 'editable', 'hideable', 'renamable', 'filter_options', 'format', 'on_change', 'sort_as_null', 'validation'.
Those elements have the following types:
...
- `persisted_props` (Array of a value equal to: 'columns.name', 'data', 'filter_query', 'hidden_columns', 'page_current', 'selected_columns', 'selected_rows', 'sort_by's; optional): Properties whose user interactions will persist after refreshing the
