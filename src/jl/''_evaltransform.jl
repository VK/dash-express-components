...
export ''_evaltransform

"""
    ''_evaltransform(;kwargs...)
...
"""
function ''_evaltransform(; kwargs...)
        available_props = Symbol[:allColOptions, :catColOptions, :config, :meta, :numColOptions]
        wild_props = Symbol[]
        return Component("''_evaltransform", "EvalTransform", "dash_express_components", available_props, wild_props; kwargs...)
end
