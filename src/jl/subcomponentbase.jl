...
export subcomponentbase

"""
    subcomponentbase(;kwargs...)
...
"""
function subcomponentbase(; kwargs...)
        available_props = Symbol[:allColOptions, :catColOptions, :config, :meta, :numColOptions]
        wild_props = Symbol[]
        return Component("subcomponentbase", "SubComponentBase", "dash_express_components", available_props, wild_props; kwargs...)
end
