...
export evaltransform

"""
    evaltransform(;kwargs...)
...
"""
function evaltransform(; kwargs...)
        available_props = Symbol[:allColOptions, :catColOptions, :config, :meta, :numColOptions]
        wild_props = Symbol[]
        return Component("evaltransform", "EvalTransform", "dash_express_components", available_props, wild_props; kwargs...)
end
