...
export combinecattransform

"""
    combinecattransform(;kwargs...)
...
"""
function combinecattransform(; kwargs...)
        available_props = Symbol[:allColOptions, :catColOptions, :config, :meta, :numColOptions]
        wild_props = Symbol[]
        return Component("combinecattransform", "CombinecatTransform", "dash_express_components", available_props, wild_props; kwargs...)
end
