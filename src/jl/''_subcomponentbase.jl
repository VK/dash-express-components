...
export ''_subcomponentbase

"""
    ''_subcomponentbase(;kwargs...)
...
"""
function ''_subcomponentbase(; kwargs...)
        available_props = Symbol[:allColOptions, :catColOptions, :config, :meta, :numColOptions]
        wild_props = Symbol[]
        return Component("''_subcomponentbase", "SubComponentBase", "dash_express_components", available_props, wild_props; kwargs...)
end
