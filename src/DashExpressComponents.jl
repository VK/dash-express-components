...
function __init__()
    ...
    external_url = "https://unpkg.com/dash_express_components@0.0.9/dash_express_components/async-graph.js",
    dynamic = nothing,
    async = :true,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash_express_components@0.0.9/dash_express_components/async-graph.js.map",
    dynamic = true,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash_express_components@0.0.9/dash_express_components/dash_express_components.min.js",
    dynamic = nothing,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash_express_components@0.0.9/dash_express_components/dash_express_components.min.js.map",
    dynamic = true,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash-core-components@0.0.9/dash_core_components/plotly.min.js",
    dynamic = nothing,
    async = :eager,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash-core-components@0.0.9/dash_core_components/async-plotlyjs.js",
    dynamic = nothing,
    async = :lazy,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash-core-components@0.0.9/dash_core_components/async-plotlyjs.js.map",
    dynamic = true,
    async = nothing,
    type = :js
)
